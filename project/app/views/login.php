...
<div class="container border d-flex justify-content-center p-3 mb-2 bg-light text-dark w-50 position-absolute top-50 start-50 translate-middle" style = "border-radius: 20px; align-items:center;">  
    <form method="POST" class="w-75 mt-1">
      ...
      <div class="eandp">
        ...
        <input type="text" name="username" value="<?= get_var('username') ?>" class="textbox"><br><br>
      </div>
      <div class="eandp">
